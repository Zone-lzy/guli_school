...
import com.lzy.eduservice.entity.EduComment;
import com.lzy.eduservice.entity.frontvo.UcenterMemberVo;
import com.lzy.eduservice.service.EduCommentService;
...
public class EduCommentController {
	...
	public R addComment(HttpServletRequest request, @RequestBody EduComment eduComment){
		...
		UcenterMemberVo memberVo = ucenterClient.getMemberInfoById(eduComment.getMemberId());
