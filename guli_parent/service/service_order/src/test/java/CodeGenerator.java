...
public class CodeGenerator {
	...
	public void run() {
		...
		gc.setOutputDir("D:\\program_workspace\\guli_parent\\service\\service_order" + "/src/main/java"); //输出目录

		gc.setAuthor("lzy"); //作者名
...
//		strategy.setInclude("edu_course","edu_chapter","edu_course_description","edu_video");//根据数据库哪张表生成，有多张表就加逗号继续填写
		...
		strategy.setTablePrefix("t" + "_"); //生成实体时去掉表前缀  ==> 这里会将t去掉
